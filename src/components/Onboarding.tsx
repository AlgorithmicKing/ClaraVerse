...
const Onboarding = ({ onComplete }: OnboardingProps) => {
  ...
  if (section === "features") {
    return (
        <div className="fixed inset-0 bg-gradient-to-br from-white to-sakura-50 dark:from-gray-900 dark:to-gray-800 flex items-start justify-center z-50 overflow-y-auto py-8 sm:py-12 overflow-x-hidden">
          <div className={`w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 space-y-8 sm:space-y-12 ${animationClass}`}>
            {/* Header section */}
                  ...
                  >
                    ...
                    <div className="w-full md:w-1/3 flex justify-center p-4 sm:p-6">
                      <div className="relative max-w-[200px] mx-auto">
                        <div className="absolute inset-0 bg-sakura-500 rounded-full blur-xl opacity-20 animate-pulse"></div>
                        <div className="bg-white dark:bg-gray-800 rounded-full p-4 sm:p-6 shadow-xl relative">
                          {useCase.icon}
                        </div>
                      </div>
                    </div>
